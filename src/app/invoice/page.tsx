...
<button className='btn-color' style={{background:"#dc5c5c"}} onClick={handlePrint}>Print your invoice</button>
      ...
      { inputvalue?.map((a)=>{
        ...
        <input  className='' defaultValue={a?.name} style={{borderBottom:'none',color:"#4e5560",textTransform:'uppercase',fontWeight:700}}></input>
      ...
      <p style={{margin:' 2rem auto 2rem auto',width:'fit-content',color:'grey'}}>Generated by Shubham </p>
      </div>
      </div>
